...
static const MapCell s_cells[20 * 9] = {
    ...
    P(0x29), P(0x55), P(0x55), P(0x55), P(0x55), P(0x55), P(0x13), P(0x07), P(0x07), P(0x07), P(0x1D), P(0x1E), P(0x3E), P(0x3B), P(0x2F), P(0x07), P(0x62), P(0x0A), P(0x0A), P(0x29),
    // Row 4: grass and gate lower portion
    P(0x29), P(0x07), P(0x07), P(0x07), P(0x2F), P(0x07), P(0x13), P(0x0B), P(0x0B), P(0x0B), P(0x65), P(0x64), P(0x28), P(0x29), P(0x0B), P(0x0B), P(0x4E), P(0x01), P(0x01), P(0x29),
    // Row 5: path, ledge, water, grass
    P(0x29), P(0x31), P(0x31), P(0x56), P(0x77), P(0x77), P(0x13), P(0x0B), P(0x0B), P(0x0B), P(0x55), P(0x55), P(0x28), P(0x29), P(0x0B), P(0x0B), P(0x4E), P(0x01), P(0x3E), P(0x29),
    // Row 6: trees and path
    P(0x29), P(0x07), P(0x07), P(0x07), P(0x07), P(0x07), P(0x07), P(0x07), P(0x07), P(0x07), P(0x07), P(0x07), P(0x24), P(0x25), P(0x07), P(0x2F), P(0x07), P(0x07), P(0x28), P(0x29),
    // Row 7: dense forest
