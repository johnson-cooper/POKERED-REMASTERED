...
def main() -> None:
    output = [
        ...
        "",
        map_layout("pewter_city", "PewterCity.blk", 10, 36, "g_tileset_overworld"),
        map_layout("pewter_mart", "PewterMart.blk", 4, 4, "g_tileset_mart"),
        ...
        map_layout("museum_1f", "Museum1F.blk", 5, 8, "g_tileset_house_general"),
