...
#screen{max-width:680px;width:100%;transition:background .5s,box-shadow .5s,border-radius .5s,padding .5s}
...
html.gb #screen{background:#f8f3f8;padding:20px;border:4px solid #181010;box-shadow:0 0 0 4px #48a058,0 0 0 10px #181010}
...
html.gba h1 span{color:#48a058}
html.gba .sub{color:#606060}
