...
#screen{max-width:420px;width:100%;transition:background .5s,box-shadow .5s,border-radius .5s,padding .5s}
...
#drop{cursor:pointer;user-select:none}
#dl-wrap{display:none}
#dl-wrap ul{width:100%}
#dl-wrap li{margin:.5em 0}
#sf{display:none}

html.gb body{background:#181010}
html.gb #screen{background:#f8f3f8;padding:12px;border:4px solid #181010;box-shadow:0 0 0 4px #48a058,0 0 0 10px #181010}
html.gb h1 span{color:#48a058}
html.gb .sub{color:#48a058}
html.gb #drop.over #drop-in{background:#48a058!important;color:#f8f3f8!important}

html.gba body{background:#0d0d1a}
html.gba #screen{background:#16213e;padding:24px;border-radius:12px;box-shadow:0 8px 32px rgba(0,0,0,.6)}
html.gba h1 span{color:#e3000b}
html.gba .sub{color:#9aa5b4}
html.gba .framed.primary{background:#e3000b!important}
html.gba .framed.neutral{background:#1e3a5f!important;color:#e8e8e8!important}
html.gba .framed.danger{background:#7a0010!important;color:#f8f3f8!important}
html.gba #drop.over #drop-in{background:#1e4a7f!important}
html.gba a.button{color:#e8e8e8;background:#e3000b;display:block;padding:12px 16px;border-radius:6px;text-align:center;text-decoration:none}
html.gba a.button:hover{background:#b8000a}
...
<span class="sub">OWNERSHIP VERIFICATION PATCHER</span>
</div>
